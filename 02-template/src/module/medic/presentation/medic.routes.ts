...
import { Validator } from "../../../core/presentacion/validator";
import { MedicApplication } from "../application/medic.application";
import { MedicRepository } from "../domain/repositories/medic.repository";
import { MedicInfrastructure } from "../infractrusture/medic.infrastructure";
...
class MedicRoute {
  ...
  getRouter() {
    ...
    this.router.post("/",  Validator.execute({ body: new MedicInsertDto() }), controller.insert.bind(controller)
    );
